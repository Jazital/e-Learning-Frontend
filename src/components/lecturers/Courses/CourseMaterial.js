        ...
        <div className="col-xl-9 col-lg-6 col-sm-6">
				...
				<div className="card overflow-hidden">
					<div className="card-header media border-0 pb-788">
					    ...
					    <div className="text-center card-body pt-4 p-0">
							<p className="mb-0 text-black">Submitted Assignment</p>
						</div>
					<div className="text-center">
						<a href= "/assignment">View Submitted Assignment</a>
					</div>
				</div>
			</div>
			...
			<div className=" main-body-card col-xl-4 col-lg-6 col-sm-6">
				<div className="card overflow-hidden">
					...
					<div className="text-center">
						<a href="/upcomingclass">View UpComing Classes</a>
					</div>
				</div>
			</div>
			...
			<div className=" main-body-card col-xl-4 col-lg-6 col-sm-6">
				<div className="card overflow-hidden">
					<div className="card-header media border-0 pb-788">
					    ...
					    <div className="text-center card-body pt-4 p-0">
							<p className="mb-0 text-black">Student Assessment</p>
						</div>
					<div className="text-center">
						<a href="#">Update Studet Assessment</a>
					</div>
				</div>
			</div>
