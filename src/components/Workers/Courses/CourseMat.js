                  ...
                  <div className="card overflow-hidden">
                     <div className="card-header media border-0 pb-788">
                        ...
                        <div className="card-body pt-4 p-0">
                           ...
                           <p className=" centercoursetext mb-0 text-black">Time: 9:45am  Tuesdays</p>
                        </div>
                  </div>
               </div>
               ...
               <div className=" main-body-card ">
                  <div className="card overflow-hidden">
                     <div className="card-header media border-0 pb-788">
                        ...
                        <div className="card-body pt-4 p-0">
                           <p className=" centercoursetext mb-0 text-black">CSC 405 - Artificial Intelligent</p>
                           <p className=" centercoursetext mb-0 text-black">Time: 9:45am  Monday</p>
                        </div>
                  </div>
               </div>
